use bevy::prelude::{Resource, ResMut, Res, KeyCode, ButtonInput};
...
pub fn change_gui_scale(keys: Res<ButtonInput<KeyCode>>, mut gui_scale: ResMut<GUIScale>)
{
	...
	if keys.just_pressed(KeyCode::BracketLeft) || keys.just_pressed(KeyCode::BracketRight) || keys.just_pressed(KeyCode::Backslash){
